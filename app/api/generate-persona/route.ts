    ...
    try {
      ...
      const imageResponse = await fetch(imageApiUrl, {
        ...
        body: JSON.stringify({
          instances: [{ 
            prompt: imagePrompt,
            negative_prompt: "full body, lower body, legs, hands, arms, extreme closeup, partial head, partial shoulders" 
          }],
