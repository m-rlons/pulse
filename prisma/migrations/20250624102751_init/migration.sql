...
-- AddForeignKey
ALTER TABLE "Bento" ADD CONSTRAINT "Bento_personaId_fkey" FOREIGN KEY ("personaId") REFERENCES "Persona"("id") ON DELETE CASCADE ON UPDATE CASCADE;
